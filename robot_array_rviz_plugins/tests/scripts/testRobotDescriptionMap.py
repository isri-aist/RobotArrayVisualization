...
class TestRobotDescriptionMap(Node):
    def __init__(self):
        ...
        fr3_mappings = {"hand": "true", "ee_id": "franka_hand"}
        ...
        self._ur5e_description = self.create_urdf(ur5_file_path, ur5_mappings)

        self._fr3_description = self.create_urdf(fr3_file_path, fr3_mappings)

        qos_profile = QoSProfile(depth=1)
        qos_profile.durability = DurabilityPolicy.TRANSIENT_LOCAL

        self._robot_description_map_publisher = self.create_publisher(
            RobotDescriptionArray, "robot_description_map", qos_profile=qos_profile
        )
    ...
    def publish_robot_description_map(self):
        ...
        self._robot_description_map_publisher.publish(robot_description_map_msg)
